  ...
  function isHelpPath() {
	try {
		...
		if (items.length > 0)
		{
			...
			if (p.toLowerCase() === 'help') return true;
			return false;
		}
	} 
	catch 
	{
		console.error('Unable to deteremine if this is the help path.');	  
  	}
  ...
  function injectShell() {
    ...
    sidebar.innerHTML = `
      ...
      <div class="sidebar-version">
        <span class="version-number">v0.6.0</span>
        <span class="version-tag">Alpha6</span>
      </div>
    `;
